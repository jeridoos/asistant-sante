...
const Login = ({ setUser }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        showNotification('Connexion réussie', `Bienvenue ${data.user_id} !`, 'success');
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <div className="flex-row">
          ...
          <button type="button" className="btn apple">
            <svg version="1.1" height="20" width="20" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 22.773 22.773">
              <g>
